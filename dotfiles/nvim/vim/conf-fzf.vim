" On windows, the preview will not work when bash.exe of wsl is used. Use git
" bash instead by placing it above wsl bash in the system environment variables.
